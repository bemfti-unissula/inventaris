    ...
    <form action="{{ route('login') }}" method="POST" class="space-y-6">
        ...
        <div class="flex items-center justify-between pt-1">
            <div class="flex items-center">
                ...
                <label for="remember" class="ml-3 text-sm text-gray-300 font-poppins font-medium select-none cursor-pointer hover:text-gray-200 transition-colors duration-200">
                    Remember me
                </label>
            </div>
