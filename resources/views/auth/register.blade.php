    ...
    <form action="{{ route('register.create') }}" method="POST" class="space-y-6">
        ...
        <div class="space-y-5">
            ...
            <div class="space-y-2">
                ...
                <select name="fakultas" id="fakultas" required
                    class="premium-input w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-rose-400 bg-gradient-to-r from-gray-700/50 to-gray-600/50 text-gray-100 border border-gray-500/50 backdrop-blur-sm transition-all duration-300 hover:bg-gray-600/60 font-poppins">
                    ...
                    <option value="FKIP" class="bg-gray-800 text-gray-100">Fakultas Keguruan dan Ilmu Pendidikan
                    </option>
                    <option value="FBSB" class="bg-gray-800 text-gray-100">Fakultas Bahasa, Sastra, dan Budaya
                    </option>
        ...
        <div class="flex items-start gap-3">
            <input type="checkbox" name="terms" id="terms"
                class="w-4 h-4 mt-1 text-rose-500 bg-gray-700/50 border border-gray-500/50 rounded focus:ring-rose-500 focus:ring-2 focus:ring-offset-0 transition-all duration-200"
                required />
            <label for="terms" class="text-sm text-gray-300 font-poppins leading-relaxed">
                I agree to the <span class="text-rose-400 hover:text-rose-300 transition-colors">Terms and
                    Conditions</span>
            </label>
        </div>
