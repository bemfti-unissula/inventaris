<x-auth.layout title="Reset Password" header="Reset Password" subheader="Enter your new password below">
    ...
    <form action="{{ route('password.update') }}" method="POST" class="space-y-6">
        ...
        <div class="space-y-5">
            ...
            <x-auth.input type="password" name="password_confirmation" id="password_confirmation" label="Confirm New Password" required />
        </div>

        <!-- Security Tips -->
        <div class="bg-gradient-to-br from-blue-900/20 via-indigo-900/15 to-purple-900/20 border border-blue-500/20 rounded-xl p-5 backdrop-blur-sm relative overflow-hidden">
            <!-- Decorative elements -->
            <div class="absolute top-0 right-0 w-20 h-20 bg-blue-500/5 rounded-full -translate-y-10 translate-x-10"></div>
            <div class="absolute bottom-0 left-0 w-16 h-16 bg-purple-500/5 rounded-full translate-y-8 -translate-x-8"></div>
            
            <div class="relative z-10">
                <div class="flex items-center mb-4">
                    <div class="flex items-center justify-center w-8 h-8 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-lg mr-3 border border-blue-400/30">
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-3">
                        <div class="flex items-center justify-center w-5 h-5 bg-emerald-500/20 rounded-full border border-emerald-400/30 flex-shrink-0 mt-0.5">
                            <i class="fas fa-check text-emerald-400 text-xs"></i>
                        </div>
                        <div class="text-xs text-gray-300 font-poppins">
                            <span class="font-medium text-gray-200">Minimal 8 karakter</span> - Gunakan kombinasi panjang untuk keamanan maksimal
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="text-xs text-gray-300 font-poppins">
                            <span class="font-medium text-gray-200">Huruf besar & kecil</span> - Kombinasi case meningkatkan kekuatan password
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="text-xs text-gray-300 font-poppins">
                            <span class="font-medium text-gray-200">Sertakan angka</span> - Tambahkan setidaknya satu digit numerik
                        </div>
                    </div>
                    
                    <div class="flex items-start space-x-3">
                        <div class="flex items-center justify-center w-5 h-5 bg-amber-500/20 rounded-full border border-amber-400/30 flex-shrink-0 mt-0.5">
                            <i class="fas fa-lightbulb text-amber-400 text-xs"></i>
                        </div>
                        <div class="text-xs text-gray-300 font-poppins">
                            <span class="font-medium text-gray-200">Hindari info pribadi</span> - Jangan gunakan nama, tanggal lahir, atau data mudah ditebak
                        </div>
                    </div>
                </div>
            </div>
