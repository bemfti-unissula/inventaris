        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-900/50 backdrop-blur-sm rounded-xl border border-gray-800/50 px-6 pt-4 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 pb-6">
                    <div class="bg-gradient-to-br from-blue-900/70 to-blue-800/50 border border-blue-700/40 rounded-xl p-4 hover:border-blue-600/60 hover:from-blue-800/80 hover:to-blue-700/60 transition-all duration-200 shadow-lg hover:shadow-blue-500/20">
                    ...
                    <div class="bg-gradient-to-br from-yellow-900/70 to-yellow-800/50 border border-yellow-700/40 rounded-xl p-4 hover:border-yellow-600/60 hover:from-yellow-800/80 hover:to-yellow-700/60 transition-all duration-200 shadow-lg hover:shadow-yellow-500/20">
                        <div class="flex items-center justify-between">
                            <div>
                    ...
                    <div class="bg-gradient-to-br from-green-900/70 to-green-800/50 border border-green-700/40 rounded-xl p-4 hover:border-green-600/60 hover:from-green-800/80 hover:to-green-700/60 transition-all duration-200 shadow-lg hover:shadow-green-500/20">
                        <div class="flex items-center justify-between">
                            <div>
                    ...
                    <div class="bg-gradient-to-br from-purple-900/70 to-purple-800/50 border border-purple-700/40 rounded-xl p-4 hover:border-purple-600/60 hover:from-purple-800/80 hover:to-purple-700/60 transition-all duration-200 shadow-lg hover:shadow-purple-500/20">
                        <div class="flex items-center justify-between">
                            <div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-300">{{ $transaksis->count() }} pinjaman ditemukan</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @if ($transaksis->count() > 0)
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                        @foreach ($transaksis as $transaksi)
                            ...
                            <div class="bg-gray-800/50 hover:bg-gray-800/80 border border-gray-700/50 hover:border-gray-600/50 rounded-xl overflow-hidden transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-gray-900/25">
                                <!-- Header -->
                                <div class="p-6 border-b border-gray-700/50">
                                    <div class="flex items-start justify-between">
                                        ...
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border {{ $statusTextColors[$transaksi->status] ?? 'bg-gray-500/20 text-gray-300 border-gray-400/30' }}">
                                ...
                                <div class="p-6 space-y-4">
                                    ...
                                    @if ($transaksi->keterangan)
                                        <div>
                                            ...
                                            <p class="text-gray-300 text-sm mt-1 line-clamp-2">{{ $transaksi->keterangan }}</p>
                                        </div>
                                    @endif
                                    ...
                                    @if ($transaksi->file && isset($transaksi->file['url']))
                                        <div class="flex items-center gap-2 text-sm">
                                            ...
                                            <a href="{{ $transaksi->file['url'] }}" target="_blank"
                                                class="text-gray-300 hover:text-white transition-colors">Lihat Surat Peminjaman</a>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="px-6 py-4 bg-gray-800/80 border-t border-gray-700/50">
                                    <div class="flex items-center justify-between">
                                        <span class="text-xs text-gray-400">
                                            Dibuat: {{ \Carbon\Carbon::parse($transaksi->created_at)->format('d/m/Y H:i') }}
                                        </span>
