...
<x-app-layout>
    ...
    <div class="py-6 px-4 bg-white min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Hero Section -->
            <div class="relative mb-16 bg-gradient-to-br from-slate-50 to-white border border-slate-200 rounded-3xl overflow-hidden shadow-xl">
                ...
                <div class="relative px-8 py-20 lg:py-28">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div class="space-y-8">
                            <!-- Professional Badge -->
                            <div class="inline-flex items-center px-4 py-2 bg-red-50 border border-red-200 rounded-full">
                                <div class="w-2 h-2 bg-red-500 rounded-full mr-3"></div>
                                <span class="text-sm font-medium text-red-700">Sistem Inventaris Digital</span>
                            </div>
                            ...
                            <p class="text-lg lg:text-xl text-slate-600 leading-relaxed max-w-lg">
                                Kelola inventaris Badan Eksekutif Mahasiswa Fakultas Teknologi Industri dengan sistem yang modern, efisien, dan terintegrasi.
                            </p>
                            
                            <!-- CTA Buttons -->
                            <div class="flex flex-col sm:flex-row gap-4 pt-4">
                                <a href="#inventory-section" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg transform hover:scale-105 hover:shadow-red-500/25">
                                ...
                                @auth
                                    @if (Auth::user()->role === 'admin')
                                        <a href="{{ route('admin.barang.index') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white hover:bg-slate-50 text-slate-700 font-semibold rounded-xl border-2 border-slate-200 hover:border-slate-300 transition-all duration-200">
                                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative group">
                                ...
                                <div class="absolute -inset-2 bg-gradient-to-r from-red-400 via-red-500 to-red-400 rounded-3xl blur-lg opacity-30 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 animate-pulse"></div>
                                <!-- Card Container -->
                                <div class="relative bg-gradient-to-br from-white via-red-50 to-red-50 backdrop-blur-sm rounded-2xl overflow-hidden shadow-2xl">
                                    <!-- Logo Container -->
                                    <div class="relative p-8">
                                        <img src="{{ asset('images/Logo-BEM-FTI.png') }}" alt="Logo BEM FTI" class="w-full h-64 object-contain drop-shadow-2xl">
                                        <!-- Decorative Elements -->
                                        <div class="absolute top-4 right-4 w-4 h-4 bg-red-400 rounded-full animate-ping"></div>
                                    </div>
                                    <!-- Enhanced Text Section -->
                                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-red-400/80 to-transparent p-6">
                                        <h3 class="text-white font-bold text-xl drop-shadow-lg">BEM FTI UNISSULA</h3>
                                        <p class="text-white text-sm font-medium drop-shadow-md">Badan Eksekutif Mahasiswa</p>
                                    </div>
                                </div>
                                
                                <!-- Subtle Background Elements -->
                                <div class="absolute -bottom-8 -left-8 w-32 h-32 bg-slate-100 rounded-full opacity-40"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <!-- Total Items Card -->
                <div class="bg-white border border-gray-200 rounded-xl p-6 group hover:shadow-lg hover:shadow-gray-500/10 transition-all duration-300">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 group hover:shadow-lg hover:shadow-gray-500/10 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $barangs->where('stok', '>', 0)->count() }}</p>
                        </div>
                ...
                <form action="{{ route('inventaris') }}" method="GET" class="space-y-4">
                    <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="relative group">
                                ...
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-500 group-hover:text-gray-600 transition-colors" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="w-full md:w-auto">
                            ...
                            <button type="submit" class="w-full md:w-auto h-12 px-6 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-medium rounded-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-red-500/50">
            ...
            <div id="gridView" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
                @forelse ($barangs as $barang)
                    <div class="transform transition-all duration-300 hover:scale-105">
                        <a href="{{ route('barang.show', $barang) }}" class="block">
                            <div class="bg-white/90 backdrop-blur-sm rounded-xl border border-gray-300 p-6 hover:bg-white transition-all duration-300 hover:border-gray-400 group shadow-lg">
                                <!-- Image -->
                                ...
                                <!-- Content -->
                                <h3 class="text-lg font-semibold text-gray-900 mb-2 group-hover:text-red-600 transition-colors">{{ $barang->nama_barang }}</h3>
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <span class="text-sm text-gray-700">
                                        ...
                                        <span class="{{ $barang->stok > 0 ? 'text-green-600' : 'text-red-600' }}">{{ $barang->stok }}</span>
                                    </span>
                                </div>
                ...
                @empty
                    <div class="col-span-full">
                        <div class="bg-white/90 backdrop-blur-sm rounded-xl border border-gray-300 p-12 text-center shadow-lg">
            ...
            <div id="listView" class="hidden space-y-4 mb-8">
                @forelse ($barangs as $barang)
                    <a href="{{ route('barang.show', $barang) }}" class="block">
                        <div class="bg-white/90 backdrop-blur-sm rounded-xl border border-gray-300 p-6 hover:bg-white transition-all duration-300 hover:border-gray-400 shadow-lg">
                            <div class="flex items-center gap-6">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            <h3 class="text-lg font-semibold text-gray-900 mb-1 truncate">{{ $barang->nama_barang }}</h3>
