    ...
    <div class="py-6 px-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <!-- Total Items Card -->
                <div
                    class="bg-gradient-to-br from-blue-600/20 to-blue-800/20 backdrop-blur-sm rounded-xl border border-blue-400/30 p-6 group hover:scale-105 transition-all duration-300">
                ...
                <div
                    class="bg-gradient-to-br from-green-600/20 to-green-800/20 backdrop-blur-sm rounded-xl border border-green-400/30 p-6 group hover:scale-105 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-green-200 text-sm font-medium">Tersedia</p>
                            <p class="text-3xl font-bold text-white mt-1">{{ $barangs->where('stok', '>', 0)->count() }}
                            </p>
                        </div>
                        <div
                ...
                <!-- Categories Card -->
                <div
                    class="bg-gradient-to-br from-purple-600/20 to-purple-800/20 backdrop-blur-sm rounded-xl border border-purple-400/30 p-6 group hover:scale-105 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                        ...
                        <div
                            class="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center group-hover:bg-purple-500/30 transition-colors">
            ...
            <div
                class="bg-gradient-to-r from-black/60 via-black/50 to-black/60 backdrop-blur-sm rounded-xl border border-white/10 p-6 mb-8 shadow-2xl">
                ...
                <form action="{{ route('inventaris') }}" method="GET" class="space-y-4">
                    <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="relative group">
                                ...
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-hover:text-gray-300 transition-colors"
                        ...
                        <div class="w-full md:w-auto">
                            ...
                            <button type="submit"
                                class="w-full md:w-auto h-12 px-6 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white font-medium rounded-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-sky-500/50">
                ...
                @empty
                    <div class="col-span-full">
                        <div class="bg-black/30 backdrop-blur-sm rounded-xl border border-white/10 p-12 text-center">
                            <div
                                class="w-16 h-16 bg-gray-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div id="listView" class="hidden space-y-4 mb-8">
                @forelse ($barangs as $barang)
                    <a href="{{ route('barang.show', $barang) }}" class="block">
                        <div
                            class="bg-black/30 backdrop-blur-sm rounded-xl border border-white/15 p-6 hover:bg-black/40 transition-all duration-300 hover:border-white/25">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="flex items-center gap-4">
                                                ...
                                                <span class="text-sm text-gray-300">
                                                    ...
                                                    <span
                                                        class="{{ $barang->stok > 0 ? 'text-green-400' : 'text-red-400' }}">{{ $barang->stok }}</span>
                                                </span>
                                            </div>
                                        </div>
