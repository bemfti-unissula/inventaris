                    ...
                    <div class="bg-gray-900/50 backdrop-blur-sm border border-gray-800/50 rounded-xl p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div
                                        class="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white flex items-center">
                                        <span
                                            class="text-lg font-semibold text-red-400">{{ $barang->total_dimiliki }}</span>
                                        <span class="ml-2 text-gray-400">unit</span>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div
                                    class="w-full min-h-[120px] px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-gray-300 leading-relaxed">
