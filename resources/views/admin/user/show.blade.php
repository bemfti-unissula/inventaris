        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center gap-4">
                ...
                <div class="flex-shrink-0">
                    @if($user->role === 'admin')
                        <span class="inline-flex items-center px-3 py-1 bg-red-500/20 text-red-300 rounded-full text-sm border border-red-400/30">
                    ...
                    @else
                        <span class="inline-flex items-center px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-sm border border-blue-400/30">
                            <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="bg-gray-900/50 backdrop-blur-sm border border-gray-800/50 rounded-xl p-8">
                ...
                <div class="text-center mb-8">
                    <div class="w-24 h-24 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-700/50">
                        <div class="flex items-center gap-3 p-4 bg-green-500/10 border border-green-400/30 rounded-lg">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-green-400">Email diverifikasi pada {{ $user->email_verified_at->format('d F Y, H:i') }}</p>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="mt-8 pt-6 border-t border-gray-700/50">
                        <div class="flex items-center gap-3 p-4 bg-yellow-500/10 border border-yellow-400/30 rounded-lg">
        ...
        <div id="deleteModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm items-center justify-center p-4 z-50 hidden">
            <div class="bg-gray-900 border border-gray-800 rounded-xl p-6 w-full max-w-md">
                <div class="text-center">
                    ...
                    <p class="text-gray-400 mb-6">Apakah Anda yakin ingin menghapus user <strong class="text-white">{{ $user->name }}</strong>? Tindakan ini tidak dapat dibatalkan.</p>
