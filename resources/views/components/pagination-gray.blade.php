    ...
    <nav role="navigation" aria-label="Pagination Navigation">
        <div class="flex items-center space-x-1">
            ...
            @if ($paginator->onFirstPage())
                <span
                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-500 bg-gray-800/50 border border-gray-700/50 cursor-not-allowed rounded-lg">
            ...
            @for ($page = $start; $page <= $end; $page++)
                @if ($page == $paginator->currentPage())
                    <span
                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-red-600 border border-red-500 cursor-default rounded-lg shadow-lg">
                        {{ $page }}
                    </span>
                @else
