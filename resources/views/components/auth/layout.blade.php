...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-black min-h-screen">
    ...
    <div class="min-h-screen relative overflow-hidden">
        ...
        <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-red-900/3 via-transparent to-red-800/3">
        </div>

        <div
            class="relative flex min-h-screen flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
            <!-- Logo Section -->
            ...
            <div class="w-full max-w-md">
                <div
                    class="bg-gradient-to-br from-gray-800/98 via-gray-800/95 to-gray-900/98 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-600/40 overflow-hidden dark-glow relative">
                    <!-- Subtle inner glow -->
                    <div
                        class="absolute inset-0 rounded-2xl bg-gradient-to-br from-white/[0.02] via-transparent to-red-500/[0.01] pointer-events-none">
                    </div>

                    <!-- Premium Header with Enhanced Styling -->
                    <div
                        class="bg-gradient-to-r from-gray-900/95 via-gray-800/90 to-gray-900/95 px-8 py-8 border-b border-gray-600/30 relative">
                        ...
                        <div
                            class="absolute top-1 left-4 right-4 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent">
                        </div>

                        <div class="text-center space-y-2">
                            <h3 class="text-2xl font-bold text-white font-poppins drop-shadow-lg tracking-tight">
                                {{ $header }}</h3>
                    ...
                    <div
                        class="px-8 py-8 bg-gradient-to-br from-gray-800/90 via-gray-800/85 to-gray-900/90 backdrop-blur-sm relative">
                        <!-- Subtle content area glow -->
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-red-900/[0.02] via-transparent to-transparent pointer-events-none">
                        </div>
