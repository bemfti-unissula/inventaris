...
import { BarangEditProps } from '@/types';

export default function Edit({ auth, barang, kategoris }: BarangEditProps) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('admin.barang.update', barang._id), {
            forceFormData: true,
        });
    };
    ...
    const getCurrentImageUrl = () => {
        ...
        if (!barang.gambar) return null;
        if (typeof barang.gambar === 'string') return barang.gambar;
        return barang.gambar.url;
    };
    ...
    return (
        ...
        >
            <Head title={`Edit Barang: ${barang.nama_barang}`} />
                        ...
                        <div className="p-6">
                            <form onSubmit={submit} className="space-y-6">
                                    ...
                                    <div className="flex items-center space-x-6">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="mt-1 text-sm text-gray-400">
                                                PNG, JPG, GIF hingga 2MB. Kosongkan jika tidak ingin mengubah gambar.
                                            </p>
                                        </div>
                                    </div>
                                    {errors.gambar && (
                                ...
                                <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700">
                                    <h3 className="text-sm font-medium text-gray-300 mb-2">Informasi Tambahan</h3>
                                    <div className="grid grid-cols-2 gap-4 text-sm">
                                        <div>
                                            <span className="text-gray-400">Total Dipinjam:</span>
                                            <span className="text-white ml-2">{barang.total_dipinjam || 0}</span>
                                        </div>
                                        <div>
