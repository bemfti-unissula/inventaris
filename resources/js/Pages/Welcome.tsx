                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    ...
                                    <>
                                        <Link
                                            href={route('login')}
                                            className="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-red-600 focus:outline-none focus-visible:ring-red-500 dark:text-white dark:hover:text-yellow-400 dark:focus-visible:ring-yellow-400"
                                        >
                                            Log in
                                        </Link>
                                        <Link
